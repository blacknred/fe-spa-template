...
// import { createProduct, getUser, mockProduct, render, screen, userEvent, waitFor, within } from '@/test/utils';
...
//     const descriptionField = within(drawer).getByText(/description/i);2
